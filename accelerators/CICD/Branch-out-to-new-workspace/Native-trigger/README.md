...
Configure a service hook on **Git branch created** events and pass payload/fields to this pipeline.
...
- To support concurrent runs safely, keep `ledger_file_path` on shared persistent storage accessible by the runner.
